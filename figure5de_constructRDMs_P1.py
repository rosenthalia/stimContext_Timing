...
# This script loads in preprocessed firing rate data for P1 and uses it to build and save out RDM files. These files are
# then reimported back into MATLAB and plotted as RDMs for figure 5d and 5e using the script figure5de_plotsP1.m
...
saveName = '../Data/stimContext_Timing_P1_RDMs.mat'

# load in preprocessed data file
matFile = '../Data/stimContext_Timing_P1_SpksForRSA.mat'
...
rsaData = rsatoolbox.data.Dataset(np.squeeze(segments[:,:].T),
                                  channel_descriptors= {'chList':chList[0][0]},
