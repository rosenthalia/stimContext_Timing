...
% python script figure5de_constructRDMs_P1.py
pyRDM = load(['..\Data\stimContext_Timing_P1_RDMs.mat']);
...
title(['P1: S1 timing sorted RDM, CV noise-corr Mahalanobis']);
...
disp(['P1: rank sum test on distances within phases/across conds vs distances within conds/across phase:'])
disp(['p=' num2str(p)])
...
localOptions.rotateAngle = 345*pi/180; % angle to rotate each bin, customized. Should be with touches pointing to northeast
