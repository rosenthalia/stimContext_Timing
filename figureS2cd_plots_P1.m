...
% python script figureS2cd_constructRDMs_P1.py
pyRDM = load(['..\Data\stimContext_Timing_P1_RDMs_EYE.mat']);
...
title(['P1: EYE timing sorted RDM, noise-corr Mahalanobis']);
...
rotateAngles = [0]*pi/180; % angle to rotate entire plot, customized. Should be with touches pointing to northeast
