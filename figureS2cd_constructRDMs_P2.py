...
# This script loads in preprocessed eyetracking data for P2 and uses it to build and save out RDM files. These files are
# then reimported back into MATLAB and plotted as RDMs for figure S2c and S2d using the script figureS2cd_plotsP2.m
...
saveName = '../Data/stimContext_Timing_P2_RDMs_EYE.mat'

plotRDM = 0 # to plot the RDM directly in Python

# load in preprocessed data file
matFile = '../Data/stimContext_Timing_P2_EyeForRSA.mat'
