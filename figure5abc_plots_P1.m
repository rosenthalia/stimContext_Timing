...
if toLoad == 1
    ...
    load(['..\Data\stimContextTiming_P1_tunedCatch_0.1bn_1000BOOTResults.mat']);
    ...
    for cati = 1:2 % for each visual condition (1=realistic, 2=abstract)
        ...
        for tr = 1: size(data,1)
            ...
            spk =  squeeze(data(tr,:,:)); % data for this trial
...
%% plots example channel activity (Fig.5b)
chs = [3 86]; % channels selected to plot
